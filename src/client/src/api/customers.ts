...
export const Customers = (client: ReturnType<typeof ApiClient>) => {
  ...
  return {
    ...
    updateAddress: (customerId, addressId, data) =>
      client.put(`${resourceUrl}/${customerId}/addresses/${addressId}`, data),
    deleteAddress: (customerId, addressId) =>
      client.delete(`${resourceUrl}/${customerId}/addresses/${addressId}`),
